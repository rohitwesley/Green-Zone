...
public class RecordHiResImageController : MonoBehaviour
{
    // Get Camera to take screen shot from
    ...
    [SerializeField] GameObject hideGameObject; 

    // optimize for many screenshots will not destroy any objects so future screenshots will be fast
    [SerializeField] bool optimizeForManyScreenshots = true;

    // configure with raw, jpg, png, or ppm (simple raw format)
    enum Format { RAW, JPG, PNG, PPM };
    [SerializeField] Format format = Format.PPM;
